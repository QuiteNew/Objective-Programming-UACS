...
#include "NegativeDiscriminantException.h"
...
Fraction operator+(Fraction a, Fraction b)
{
	...
	if(f.den < 0)
	{
		f.num *= -1;
		f.den *= -1;
		throw NegativeDiscriminantException("operator+");
...
int main()
{
    ...
    catch (const NegativeDiscriminantException negDisExc) {
        cout << negDisExc.what() << endl;
    }
