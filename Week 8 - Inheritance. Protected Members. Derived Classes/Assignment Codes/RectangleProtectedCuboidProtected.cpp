...
double Cuboid::getA()			// added
{
	return this->Rectangle::getA();
}

double Cuboid::getB()			// added
{
	return this->Rectangle::getB();
}

double Cuboid::baseArea()		// added
{
...
void main()
{
	...
	cout << "Base area:\t" << C.baseArea() /* or C.Rectangle::area() */ << endl;
